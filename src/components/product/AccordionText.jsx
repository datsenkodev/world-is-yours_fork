  ...
  const data = [
    {
      id: 1,
      title: 'Особливості',
      subtitle: 'Технології обтічного дизайну',
      content:
        'Трекінгове взуття Salomon відзначається ергономічним та обтічним дизайном,' +
        'що надає винятковий комфорт та підтримку під час активних пригод.',
    },
    {
      id: 2,
      title: 'Матеріал',
      subtitle: 'Тут має бути підзаголовок',
      content: 'Тут текст про матеріал',
    },
    {
      id: 3,
      title: 'Догляд',
      subtitle: 'Тут має бути підзаголовок',
      content: 'Тут текст про догляд',
    },
  ];
